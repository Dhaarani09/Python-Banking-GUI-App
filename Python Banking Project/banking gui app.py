...
#Labels
Label(master, text = "INTERNET BANKING BETA", font=('Calibri',14)).grid(row=0,sticky=N,pady=10)
Label(master, text = "ராஸியான பேங்க் ஈஸியான பேங்க்", font=('Calibri',12)).grid(row=1,sticky=N)
